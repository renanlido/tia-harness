...
description: >-
  ...
  wants to see exactly what scaffolding a spec would do and in what order. Class R: runs
  tia_spec_validate then tia_spec_plan, both PURE (no serve, no TIA Portal). Output: the
